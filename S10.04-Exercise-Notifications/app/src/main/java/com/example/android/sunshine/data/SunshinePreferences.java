...
public final class SunshinePreferences {
    ...
    public static boolean areNotificationsEnabled(Context context) {
        /* Key for accessing the preference for showing notificaitons */
        String displayNotificaitonsKey = context.getString(R.string.pref_enable_notifications_key);
        ...
        boolean shouldDisplayNotifications = sp
                .getBoolean(displayNotificaitonsKey, shouldDisplayNotificationsByDefault);
